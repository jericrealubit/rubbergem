...
- `migrate.js` is a one-off script used previously to backfill `production_logs` from a legacy `public/rubbergem/data/data.json` file. It hardcodes empty Supabase credentials — not runnable as-is, kept for reference only.
